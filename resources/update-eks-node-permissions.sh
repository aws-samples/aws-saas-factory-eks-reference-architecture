...
echo '{"Version": "2012-10-17","Statement": [{"Sid": "VisualEditor0","Effect": "Allow","Action": ["iam:*","eks:UntagResource","eks:TagResource","cloudformation:*","dynamodb:*","eks:Describe*"],"Resource": "*"}]}' > /tmp/iam-role-policy
